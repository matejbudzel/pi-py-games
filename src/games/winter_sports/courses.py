...
COURSES = {
    ...
    "Speed skating": (Course("Short Track", (Segment(70), Segment(45, 1.5), Segment(70), Segment(45, 1.5), Segment(70))), Course("Large Oval", (Segment(120), Segment(80, .65), Segment(120), Segment(80, .65)))),
...
PROFILES = {
    ...
    "Speed skating": Profile(6, 1.3, 2.2, .9, 23), "Alpine skiing": Profile(5, 1.5, 2.0, .9, 20), "Snowboard slalom": Profile(4, 1.0, 3.7, .8, 18),
